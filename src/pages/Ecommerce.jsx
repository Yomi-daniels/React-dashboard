  ...
  return (
    <div className="mt-24 ">
      <div className="flex flex-wrap lg:flex-nowrap justify-center ">
        <div className="relative dark:text-gray-200 !dark:bg-secondary-dark-bg h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center overflow-hidden bg-white hover:drop-shadow-xl">
